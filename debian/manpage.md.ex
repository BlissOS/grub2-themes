% grub-theme-blissos(SECTION) | User Commands
%
% "December 10 2024"
...
grub-theme-blissos - program to do something

# SYNOPSIS

**grub-theme-blissos** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**grub-theme-blissos** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **grub-theme-blissos** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**grub-theme-blissos** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    grub-theme-blissos. See **foo.conf**(5) for further details.
...
**grub-theme-blissos** provides some return codes, that can be used in scripts:
